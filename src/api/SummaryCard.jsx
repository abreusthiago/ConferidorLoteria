...
export default function SummaryCard({ acertos, quantidade, total }) {
  const configs = {
    6: { label: "Sena (6)", color: "text-emerald-600", bg: "bg-emerald-50", bar: "bg-emerald-500" },
    5: { label: "Quina (5)", color: "text-blue-600", bg: "bg-blue-50", bar: "bg-blue-500" },
    4: { label: "Quadra (4)", color: "text-amber-600", bg: "bg-amber-50", bar: "bg-amber-500" },
    3: { label: "3 acertos", color: "text-purple-600", bg: "bg-purple-50", bar: "bg-purple-500" },
    2: { label: "2 acertos", color: "text-slate-600", bg: "bg-slate-50", bar: "bg-slate-400" },
